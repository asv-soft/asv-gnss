...
public static class UbxMicroserviceClientHelper
{
    #region MonVer
    ...
    public static Task<UbxMonVer?> GetMonVer(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
        return src.Pool<UbxMonVer, UbxMonVerPool>(new UbxMonVerPool(), cancel: cancel);
    }
    ...
    public static Task<UbxCfgPrt?> GetCfgPort(this IUbxMicroserviceClient src, byte portId, CancellationToken cancel = default)
    {
        return src.Pool<UbxCfgPrt, UbxCfgPrtPool>(new UbxCfgPrtPool { PortId = portId }, cancel: cancel);
    }
    ...
    /// </returns>
    public static Task SetCfgPort(this IUbxMicroserviceClient src, UbxCfgPrt value, CancellationToken cancel = default)
    {
        return src.Push(value, cancel: cancel);
    }
    ...
    public static Task<UbxCfgAnt?> GetCfgAntenna(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
        return src.Pool<UbxCfgAnt, UbxCfgAntPool>(new UbxCfgAntPool(), cancel: cancel);
    }
    ...
    public static Task SetCfgAntenna(this IUbxMicroserviceClient src, UbxCfgAnt value, CancellationToken cancel = default)
    {
        return src.Push(value, cancel: cancel);
    }
    ...
    public static Task<UbxCfgRate?> GetCfgRate(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
        return src.Pool<UbxCfgRate, UbxCfgRatePool>(new UbxCfgRatePool(), cancel: cancel);
    }
    ...
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task SetCfgRate(this IUbxMicroserviceClient src, UbxCfgRate value, CancellationToken cancel = default)
    {
        return src.Push(value, cancel: cancel);
    }
    ...
    public static Task<UbxCfgMsg?> GetCfgMsg(this IUbxMicroserviceClient src, byte msgClass, byte msgSubClass,
        CancellationToken cancel = default)
    {
        return src.Pool<UbxCfgMsg, UbxCfgMsgPool>(new UbxCfgMsgPool { MsgClass = msgClass, MsgId = msgSubClass },
            cancel: cancel);
    }
    ...
    public static Task SetCfgMsg(this IUbxMicroserviceClient src, UbxCfgMsg msg, CancellationToken cancel = default)
    {
        return src.Push(msg, cancel: cancel);
    }
    ...
    public static Task SetMessageRate(this IUbxMicroserviceClient src, byte msgClass, byte msgSubClass, byte msgRate,
        CancellationToken cancel = default)
    {
        return src.SetCfgMsg(new UbxCfgMsg { MsgClass = msgClass, MsgId = msgSubClass, CurrentPortRate = msgRate },
            cancel);
    }
    ...
    /// <param name="cancel">The cancellation token (optional).</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task SetMessageRate<TMsg>(this IUbxMicroserviceClient src, byte msgRate, CancellationToken cancel = default)
        where TMsg : UbxMessageBase, new()
    {
        var msg = new TMsg();
        return src.SetCfgMsg(new UbxCfgMsg { MsgClass = msg.Class, MsgId = msg.SubClass, CurrentPortRate = msgRate },
            cancel);
    }
    ...
    public static Task<UbxCfgNav5?> GetCfgNav5(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
        return src.Pool<UbxCfgNav5, UbxCfgNav5Pool>(new UbxCfgNav5Pool(), cancel: cancel);
    }
    ...
    /// /
    public static Task SetCfgNav5(this IUbxMicroserviceClient src, UbxCfgNav5 value, CancellationToken cancel = default)
    {
        return src.Push(value, cancel: cancel);
    }
    ...
    /// <returns>A Task representing the asynchronous operation.</returns>
    public static async Task SetupRtcmMSM4Rate(this IUbxMicroserviceClient src, byte msgRate, CancellationToken cancel)
    {
        // 1074
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RTCM3, 0x4A, msgRate, cancel);

        // 1084
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RTCM3, 0x54, msgRate, cancel);

        // 1094
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RTCM3, 0x5E, msgRate, cancel);

        // 1124
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RTCM3, 0x7C, msgRate, cancel);
    }
    ...
    /// </returns>
    public static async Task SetupRtcmMSM7Rate(this IUbxMicroserviceClient src, byte msgRate, CancellationToken cancel)
    {
        // 1077
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RTCM3, 0x4D, msgRate, cancel);

        // 1087
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RTCM3, 0x57, msgRate, cancel);

        // 1097
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RTCM3, 0x61, msgRate, cancel);

        // 1127
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RTCM3, 0x7F, msgRate, cancel);
    }
    ...
    /// <param name="cancel">The cancellation token.</param>
    /// <returns>A Task representing the asynchronous operation.</returns>
    public static Task CallCfgClear(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
    ...
    /// </remarks>
    public static Task CallCfgSave(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
        return src.Push(new UbxCfgCfg
        {
            ClearMask = UbxCfgSection.All,
    ...
    /// </returns>
    public static Task CallCfgLoad(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
        return src.Push(new UbxCfgCfg
        {
    ...
    /// <param name="cancel">The cancellation token to cancel the operation.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task CallCfgReset(this IUbxMicroserviceClient src, BbrMask navBbrMask = BbrMask.HotStart,
        ResetMode resetMode = ResetMode.HardwareResetImmediately, CancellationToken cancel = default)
    {
        return src.Push(new UbxCfgRst { Bbr = navBbrMask, Mode = resetMode }, cancel: cancel);
    }
    ...
    /// <param name="cancel">Optional cancellation token.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task HardwareReset(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
        return src.CallCfgReset(BbrMask.HotStart, ResetMode.HardwareResetImmediately, cancel: cancel);
    }
    ...
    public static async Task SoftwareGnssReset(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
        // return src.CallCfgReset(BbrMask.ColdStart, ResetMode.ControlledSoftwareResetGnssOnly, cancel);
        try
        {
            await src.Push(new UbxCfgRst { Bbr = BbrMask.ColdStart, Mode = ResetMode.ControlledSoftwareResetGnssOnly },
                100, 1, cancel);
        }
        catch (Exception)
        {
    ...
    public static Task<UbxMonHw?> GetMonHw(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
        return src.Pool<UbxMonHw, UbxMonHwPool>(new UbxMonHwPool(), cancel: cancel);
    }
    ...
    /// the UBX device.
    /// </remarks>
    public static Task<UbxCfgTMode3?> GetCfgTMode3(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
        return src.Pool<UbxCfgTMode3, UbxCfgTMode3Pool>(new UbxCfgTMode3Pool(), cancel: cancel);
    }
    ...
    /// <param name="cancel">The cancellation token (optional).</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task SetCfgTMode3(this IUbxMicroserviceClient src, UbxCfgTMode3 value, CancellationToken cancel = default)
    {
        return src.Push(value, cancel: cancel);
    }
    ...
    /// <returns>A Task representing the asynchronous operation.</returns>
    public static Task SetSurveyInMode(this IUbxMicroserviceClient src, uint minDuration = 60, double positionAccuracyLimit = 10,
        CancellationToken cancel = default)
    {
    ...
    /// <param name="cancel">A cancellation token to cancel the operation.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task SetFixedBaseMode(this IUbxMicroserviceClient src, GeoPoint position, double position3DAccuracy = 0.0001,
        CancellationToken cancel = default)
    {
        return src.SetCfgTMode3(new UbxCfgTMode3
        {
    ...
    public static Task<UbxNavSat?> GetNavSat(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
        return src.Pool<UbxNavSat, UbxNavSatPool>(new UbxNavSatPool(), cancel: cancel);
    }
    ...
    public static Task<UbxNavPvt?> GetNavPvt(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
        return src.Pool<UbxNavPvt, UbxNavPvtPool>(new UbxNavPvtPool(), cancel: cancel);
    }
    ...
    /// <param name="cancel">The cancellation token.</param>
    /// <returns>A Task representing the asynchronous operation.</returns>
    public static async Task SetStationaryMode(this IUbxMicroserviceClient src, bool movingBase, byte msgRate,
        CancellationToken cancel = default)
    {
        if (!movingBase)
        {
            ...
            // 4072
            await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RTCM3, 0xFE, 0, cancel);
        }
        else
        {
            await src.SetCfgNav5(new UbxCfgNav5
            ...
            // 4072
            await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RTCM3, 0xFE, msgRate, cancel);
        }
    }
    ...
    /// <param name="cancel">The cancellation token to cancel the operation.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static async Task TurnOffNmea(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
        // turn off all nmea
        for (var a = 0; a <= 0xf; a++)
        {
            if (a is 0x0B or 0x0C or 0x0E)
                continue;
            await src.SetMessageRate((byte)UbxProtocol.ClassIDs.NMEA, (byte)a, 0, cancel);
        }
    }
    ...
    public static async Task RebootReceiver(this IUbxMicroserviceClient src, CancellationToken cancel = default)
    {
    ...
    /// <param name="cancel">The cancellation token.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static async Task SetupByDefault(this IUbxMicroserviceClient src, bool movingBase = false, byte messageRate = 1,
        CancellationToken cancel = default)
    {
        ...
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.NAV, 0x3B, 1, cancel);

        // pvt msg - for feedback
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.NAV, 0x07, 1, cancel);

        // 1005 - 5s
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RTCM3, 0x05, 5, cancel);

        await src.SetupRtcmMSM4Rate(messageRate, cancel);
        await src.SetupRtcmMSM7Rate(0, cancel);

        // 1230 - 5s
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RTCM3, 0xE6, 5, cancel);

        // NAV-VELNED - 1s
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.NAV, 0x12, 1, cancel);

        // rxm-raw/rawx - 1s
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RXM, 0x15, 1, cancel);
        //await SetMessageRate((byte)UbxHelper.ClassIDs.RXM, 0x10, 1, cancel);

        // rxm-sfrb/sfrb - 2s
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.RXM, 0x13, 2, cancel);
        //await SetMessageRate((byte)UbxHelper.ClassIDs.RXM, 0x11, 2, cancel);

        // mon-hw - 2s
        await src.SetMessageRate((byte)UbxProtocol.ClassIDs.MON, 0x09, 2, cancel);
    }
}