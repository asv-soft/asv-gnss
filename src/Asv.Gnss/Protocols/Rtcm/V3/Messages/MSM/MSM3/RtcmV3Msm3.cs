...
namespace Asv.Gnss
{
    ...
    /// </summary>
    public abstract class RtcmV3Msm3 : RtcmV3MsmBase
    {
        ...
        private void CreateMsmObservable(double[] roughRanges, double[] pseudorange, double[] phaseRange, byte[] @lock, byte[] halfCycle)
        {
