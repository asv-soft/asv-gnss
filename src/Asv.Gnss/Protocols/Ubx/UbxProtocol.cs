...
public static class UbxProtocol
{
    public static ProtocolInfo Info { get; } = new("UBX", "UBX");
    
    public static void RegisterUbxProtocol(this IProtocolParserBuilder builder, Action<IProtocolMessageFactoryBuilder<UbxMessageBase, ushort>>? configure = null)
    {
        var factory = new ProtocolMessageFactoryBuilder<UbxMessageBase, ushort>(Info);
        ...
        builder.Register(Info, (core,stat) => new UbxMessageParser(messageFactory, core,stat));
    }
