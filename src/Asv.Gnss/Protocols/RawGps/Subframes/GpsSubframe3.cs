...
public class GpsSubframe3 : GpsSubframeBase
{
    ...
    public override void Deserialize(byte[] dataWithoutParity)
    {
        ...
        word3Start += 16;
        OMG0 = GpsRawHelper.GetBitS(dataWithoutParity, word3Start, 32) * GpsRawHelper.P2_31 * GpsRawHelper.SC2RAD;
        word3Start += 32;
        Cis = GpsRawHelper.GetBitS(dataWithoutParity, word3Start, 16) * GpsRawHelper.P2_29;
        word3Start += 16;
        i0 = GpsRawHelper.GetBitS(dataWithoutParity, word3Start, 32) * GpsRawHelper.P2_31 * GpsRawHelper.SC2RAD;
        word3Start += 32;
        Crc = GpsRawHelper.GetBitS(dataWithoutParity, word3Start, 16) * GpsRawHelper.P2_5;
        word3Start += 16;
        omg = GpsRawHelper.GetBitS(dataWithoutParity, word3Start, 32) * GpsRawHelper.P2_31 * GpsRawHelper.SC2RAD;
        word3Start += 32;
        OMGd = GpsRawHelper.GetBitS(dataWithoutParity, word3Start, 24) * GpsRawHelper.P2_43 * GpsRawHelper.SC2RAD;
        word3Start += 24;
        iode = (int)GpsRawHelper.GetBitU(dataWithoutParity, word3Start, 8);
        word3Start += 8;
        idot = GpsRawHelper.GetBitS(dataWithoutParity, word3Start, 14) * GpsRawHelper.P2_43 * GpsRawHelper.SC2RAD;
        word3Start += 14;
    }
