...
public class AsvMessageGloRawCa : AsvMessageBase
{
    ...
    protected override void InternalSerialize(ref Span<byte> buffer)
    {
        ...
        AsvHelper.SetBitU(buffer, (uint)NAVBitsU32.Length, ref bitIndex, 4);
        bitIndex += 4;
        buffer = buffer[(bitIndex / 8)..];
    ...
    protected override int GetPayloadByteSize() => 8 + NAVBitsU32.Length * NavBitsU32Length * sizeof(uint);
