...
{
    public static readonly ushort PacketMessageId = 0x0000;
    ...
    public override void Randomize(Random random)
    {
        ...
        DeviceType = (AsvDeviceType)random.Next(0, Enum.GetValues<AsvDeviceType>().Length);
        DeviceState = (AsvDeviceState)random.Next(0, Enum.GetValues<AsvDeviceState>().Length);
