...
namespace Asv.Gnss
{
    public class SbfPacketMeasEpochRev1 : SbfMessageBase
    {
        ...
        /// <summary>
        /// Gets or sets cumulative millisecond clock jumps since start-up, with an ambiguity of
        ...
        /// <summary>
        /// Gets or sets reserved for future use, to be ignored by decoding software.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets length of a MeasEpochChannelType2 sub-block.
        /// </summary>
        public byte SB2Length { get; set; }

        /// <summary>
        /// Gets or sets length of a MeasEpochChannelType1 sub-block, excluding the nested MeasEpochChannelType2 sub-blocks.
        /// </summary>
    ...
    public class MeasEpochChannelType1
    {
        ...
        /// <summary>
        /// Gets or sets duration of continuous carrier phase. The lock-time is reset at the initial
        /// lock of the phase-locked-loop, and whenever a loss of lock condition occurs.
        /// </summary>
        public ushort LockTime { get; set; }

        /// <summary>
        /// Gets or sets the C/N0 in dB-Hz.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets mSB of the carrier phase relative to the pseudorange. The full carrier phase can be computed by:
        ...
        /// <summary>
        /// Gets or sets sB of the pseudorange. The pseudorange expressed in meters
