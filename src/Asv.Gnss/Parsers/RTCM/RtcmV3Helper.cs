...
namespace Asv.Gnss
{
    public static class RtcmV3Helper
    {
        ...
        public static double GetMinLockTimeEx(ushort indicator)
        {
            ...
            if (indicator >= 705 && indicator <= 1023)
            {
                return 0;
            }
