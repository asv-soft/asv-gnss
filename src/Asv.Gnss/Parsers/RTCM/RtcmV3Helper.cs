...
namespace Asv.Gnss
{
    public static class RtcmV3Helper
    {
        ...
        { /* code priority for each freq-index */
            ...
            new[] { "CABXZ", "IQX", "IQX", "ABCXZ", "IQX", string.Empty, string.Empty }, /* GAL */
            new[] { "CLSXZ", "LSX", "IQXDPZ", "LSXEZ", string.Empty, string.Empty, string.Empty }, /* QZS */
            new[]
            {
                "C",
                "IQX",
            ...
            new[] { "IQXDPAN", "IQXDPZ", "DPX", "IQXA", "DPX", string.Empty, string.Empty }, /* BDS */
            new[]
            {
                "ABCX",
                "ABCX",
        ...
        public static double GetMinLockTimeEx(ushort indicator)
        {
            ...
            {
                <= 63 => indicator / 60000.0,
                >= 64 and <= 95 => (2 * indicator - 64) / 60000.0,
                >= 96 and <= 127 => (4 * indicator - 256) / 60000.0,
                >= 128 and <= 159 => (8 * indicator - 768) / 60000.0,
                >= 160 and <= 191 => (16 * indicator - 2048) / 60000.0,
                >= 192 and <= 223 => (32 * indicator - 5120) / 60000.0,
                >= 224 and <= 255 => (64 * indicator - 12288) / 60000.0,
                >= 256 and <= 287 => (128 * indicator - 28672) / 60000.0,
                >= 288 and <= 319 => (256 * indicator - 65536) / 60000.0,
                >= 320 and <= 351 => (512 * indicator - 147456) / 60000.0,
                >= 352 and <= 383 => (1024 * indicator - 327680) / 60000.0,
                >= 384 and <= 415 => (2048 * indicator - 720896) / 60000.0,
                >= 416 and <= 447 => (4096 * indicator - 1572864) / 60000.0,
                >= 448 and <= 479 => (8192 * indicator - 3407872) / 60000.0,
                >= 480 and <= 511 => (16384 * indicator - 7340032) / 60000.0,
                >= 512 and <= 543 => (32768 * indicator - 15728640) / 60000.0,
                >= 544 and <= 575 => (65536 * indicator - 33554432) / 60000.0,
                >= 576 and <= 607 => (131072 * indicator - 71303168) / 60000.0,
                >= 608 and <= 639 => (262144 * indicator - 150994944) / 60000.0,
                >= 640 and <= 671 => (524288 * indicator - 318767104) / 60000.0,
                >= 672 and <= 703 => (1048576 * indicator - 671088640) / 60000.0,
                704 => (2097152 * indicator - 1409286144) / 60000.0,
                >= 705 and <= 1023 => 0,
                _ => 0.0,
            };
        }
