...
namespace Asv.Gnss
{
    ...
    public class RtcmV2Message31 : RtcmV2MessageBase
    {
        ...
        /// <summary>
        /// Deserializes the content of the buffer into the ObservationItems array. </summary>
        /// <param name="buffer">The buffer containing the serialized data.</param>
        /// <param name="bitIndex">The current bit index within the buffer.</param>
        /// <param name="payloadLength">The length of the payload within the buffer.</param>
