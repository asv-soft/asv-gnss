...
namespace Asv.Gnss
{
    ...
    public class ComNavBinaryPsrPosPacket : ComNavBinaryMessageBase
    {
        ...
        /// <summary>
        /// Gets or sets signals used mask - if 0, signals used in solution are unknown. See Table 33.
        /// </summary>
        public byte SignalMask { get; set; }

        /// <summary>
        /// Gets or sets extended solution status (default: 0).
        /// </summary>
        public byte ExtSolutionStatus { get; set; }

        /// <summary>
        /// Gets or sets number of satellite vehicles use.d in solution.
        /// </summary>
        public byte SolutionSats { get; set; }

        /// <summary>
        /// Gets or sets number of satellite vehicles tracke.d.
        /// </summary>
        public byte TracketSats { get; set; }

        /// <summary>
        /// Gets or sets solution age in seconds.
        /// </summary>
        public float SolutionAgeSec { get; set; }

        /// <summary>
        /// Gets or sets differential age in seconds.
        /// </summary>
        public float DifferentialAgeSec { get; set; }

        /// <summary>
        /// Gets or sets this is station ID of the station, who sending DGPS corrections (Not Current station id!).
        /// </summary>
        public string BaseStationId { get; set; }

        /// <summary>
        /// Gets or sets height standard deviation.
        /// </summary>
        public float HeightMslSd { get; set; }

        /// <summary>
        /// Gets or sets longitude standard deviation.
        /// </summary>
        public float LongitudeSd { get; set; }

        /// <summary>
        /// Gets or sets latitude standard deviation.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets undulation - the relationship between the geoids and the WGS84 ellipsoid (m).
        /// </summary>
        public float Undulation { get; set; }

        /// <summary>
        /// Gets or sets height above mean sea level.
        /// </summary>
