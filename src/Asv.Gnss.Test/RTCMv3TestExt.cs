...
namespace Asv.Gnss.Test
{
    public class RTCMv3TestExt
    {
        ...
        public void TestMsg1042()
        {
            var array = new byte[]
            {
                0xd3,0x00,0x40,0x41,0x28,0xc7,0x1c,0x1e,0xc5,0x05,0x2e,0x58,0x00,0x3f,0xde,0x66,0x4f,0xb3,0x6b,0x0f,
                0xdb,0xe6,0x5d,0xc6,0x6e,0x64,0x03,0x7b,0xf1,0x9e,0x80,0x36,0xcf,0x68,0x81,0xbb,0xf4,0xa2,0xaa,0xeb,
                0xc9,0x72,0xcf,0xff,0x18,0xe0,0xf0,0xec,0x04,0x01,0x16,0x27,0x11,0xb3,0x1e,0x14,0x75,0x45,0xe8,0xf3,
                0x5c,0x3f,0xeb,0xf4,0xbe,0xdf,0xb4,0x8c,0x66,0xfd
            };
        ...
        public void TestMsg1046()
        {
            var array = new byte[]
            {
                0xd3,0x00,0x3f,0x41,0x61,0x53,0x68,0x07,0x6b,0x05,0x5d,0x44,0x60,0x00,0x01,0xf1,0xff,0xc3,0x20,0x18,
                0x02,0x14,0x99,0x79,0xd3,0x13,0x72,0xdc,0x01,0x48,0x00,0x89,0xdb,0x80,0x27,0xe2,0xa8,0x13,0xb6,0x05,
                0x44,0x60,0x00,0xda,0x55,0x76,0xa5,0xcf,0xfe,0x72,0x70,0xd8,0x10,0x71,0xe3,0x9d,0x17,0xe7,0x50,0x6f,
                0xfc,0x0f,0xf0,0x34,0x0f,0x00,0x95,0x78,0x82
            };
            //   File.WriteAllBytes("rtcm1125.log", array);
            var parser = new RtcmV3Parser().RegisterExtendedMessages();
            RtcmV3MessageBase msg = null;
