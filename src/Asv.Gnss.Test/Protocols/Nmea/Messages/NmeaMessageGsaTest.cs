    ...
    {
        {
            ...
            "$GPGSA,M,3,05,02,31,06,19,29,20,12,24,25,,,0.90,0.50,0.70,"
        },
        
        {
            // 1
            "$GNGSA,M,3,03,14,17,06,12,19,02,01,24,32,,,0.8,0.5,0.6*22",
            "$GNGSA,M,3,03,14,17,06,12,19,02,01,24,32,,,0.80,0.50,0.60,"
        },
        {
            // 2
            "$GNGSA,M,3,66,85,75,67,73,84,83,,,,,,0.8,0.5,0.6*26",
            "$GNGSA,M,3,66,85,75,67,73,84,83,,,,,,0.80,0.50,0.60,"
        },
        {
            // 3
            "$GNGSA,M,3,12,11,33,31,03,24,25,08,,,,,0.8,0.5,0.6*20",
            "$GNGSA,M,3,12,11,33,31,03,24,25,08,,,,,0.80,0.50,0.60,"
        },
        {
            // 4
            "$GNGSA,M,3,28,46,36,27,39,23,43,37,,,,,0.8,0.5,0.6*2B",
            "$GNGSA,M,3,28,46,36,27,39,23,43,37,,,,,0.80,0.50,0.60,"
        },
        {
            // 5
            "$GNGSA,A,3,21,5,29,25,12,10,26,2,,,,,1.2,0.7,1.0*27",
            "$GNGSA,A,3,21,05,29,25,12,10,26,02,,,,,1.20,0.70,1.00,"
        },
        {
            // 6
            "$GNGSA,A,3,65,67,80,81,82,88,66,,,,,,1.2,0.7,1.0*20",
            "$GNGSA,A,3,65,67,80,81,82,88,66,,,,,,1.20,0.70,1.00,"
        }
    };
